...
<div id="content">
    ...
    <?php
      if ( get_query_var( 'err' ) == "The basket is empty" ) {
        $error = "Payment amount field may not be empty";
	    } else {
    ...
    if ( jQuery( '#payment_designation' ).val() == "Student Tuition" ) {
      jQuery("#specification").attr( "placeholder", "Applicant Name" ).show();
    }
    
    if ( jQuery( '#payment_designation' ).val() == "Staff Application" ) {
      jQuery("#specification").attr( "placeholder", "Applicant Name" ).show();
    } 
    
    if ( jQuery( '#payment_designation' ).val() == "Student Application" ) {
      jQuery("#specification").attr( "placeholder", "Applicant Name" ).show();
    }
    ...
    jQuery("#payment-info").html( payment );
	  ...
	  jQuery("#payment_designation").change(function() {
	    var show = false;
	    
	    if ( jQuery( this ).val() == "Student Tuition" ) {
	      jQuery("#specification").attr( "placeholder", "Please specify student's name" ).show();
	      show = true;
	    }
	    if ( jQuery( this ).val() == "Staff Application" ) {
	      jQuery("#specification").attr( "placeholder", "Please specify applicant name" ).show();
	      show = true;
	    }
	    if ( jQuery( this ).val() == "Student Application" ) {
	      jQuery("#specification").attr( "placeholder", "Please specify student's name" ).show();
	      show = true;
	    }
	  ...
	  jQuery("#Donation").submit(function() {
	    var designation = jQuery("#Donation #payment_designation").val();
	...
	<fieldset>
		<legend>Payment Designation</legend>
		<select id="payment_designation">
      <option value="Student Tuition">Student Tuition</option>
	...
	<fieldset>  
		...
		<input id="UnitDeductible1" type="hidden" name="UnitDeductible1" value="0%"> 
	</fieldset>
	<fieldset>  
	...
	<fieldset>
	  ...
	  <div id="payment-info">
		...
		<input id="OnSuccessUrl" type="hidden" name="OnSuccessUrl" value="http://www.ywamsf.org/payment-authorize" />

		<input id="OnDeclineUrl" type="hidden" name="OnDeclineUrl" value="http://www.ywamsf.org/payment" />

		<input id="OnErrorUrl" type="hidden" name="OnErrorUrl" value="http://www.ywamsf.org/payment" />
		...
		<input id="WID" type="hidden" name="WID" value="77427" />
		...
		<input id="Submit" type="submit" name="Submit" value="Submit Payment" />
	</form>
